...
namespace EscpPrinterWrapperLib.Tests
{
    public class EscpPrinterWrapperTests
    {
        ...
        public void WrapText_ShouldReturnCorrectEscpCommand()
        {
            ...
            string result = wrapper.WrapText("Hello World", 24, EscpPrinterWrapper.FontType.FontA, EscpPrinterWrapper.Bold.On, EscpPrinterWrapper.Italic.Off, EscpPrinterWrapper.Underline.Single, EscpPrinterWrapper.Alignment.Center, EscpPrinterWrapper.Spacing.Wide);
        ...
        {
            var wrapper = new EscpPrinterWrapper(null);
            string result = wrapper.WrapBarcode("123456789", EscpPrinterWrapper.BarcodeType.CODE128, 70, EscpPrinterWrapper.BarcodeWidth.Medium, EscpPrinterWrapper.BarcodeRatio.TwoToOne, true, EscpPrinterWrapper.Alignment.Center);
        ...
        public void GeneratePrintCommand_ShouldReturnCorrectCommand()
        {
            ...
            {
                wrapper.WrapText("Test", 24, EscpPrinterWrapper.FontType.FontA, EscpPrinterWrapper.Bold.On, EscpPrinterWrapper.Italic.Off, EscpPrinterWrapper.Underline.Single, EscpPrinterWrapper.Alignment.Center, EscpPrinterWrapper.Spacing.Wide),
                wrapper.WrapBarcode("123456789", EscpPrinterWrapper.BarcodeType.CODE128, 70, EscpPrinterWrapper.BarcodeWidth.Medium, EscpPrinterWrapper.BarcodeRatio.TwoToOne, true, EscpPrinterWrapper.Alignment.Center)
            };
