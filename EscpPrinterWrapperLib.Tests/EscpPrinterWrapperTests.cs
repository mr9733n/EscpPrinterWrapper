...
namespace EscpPrinterWrapperLib.Tests
{
    public class EscpPrinterWrapperTests
    {
        ...
        public void GeneratePrintCommand_ShouldReturnCorrectCommand()
        {
            ...
            {
                wrapper.WrapText("Test", 24, FontType.Helsinki, Bold.On, Italic.Off, Underline.Single, Alignment.Center, Spacing.Wide),
            ...
            string expected = EscapeNonPrintable("\u001b@\u001biL\u001bSOH\u001bX24\u001bk3\u001bE\u001b5\u001b-1\u001ba1\u001b 1Test\r\u001biar1h70w2z2\u001ba1B123456789\\\u001biC\u000c");
            Assert.Equal(expected, EscapeNonPrintable(result));
